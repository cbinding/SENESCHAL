<?php
	...
	Project		: SENESCHAL
	Service		: getConceptsForScheme
	Params		: schemeURI - URI of the scheme
				  ...
				  [language] - restrict labels to the specified language
	Summary		: Get the concepts for the specified schemeURI
	License		: http://creativecommons.org/licenses/by/3.0 
	================================================================================
	Example		:
	/getConceptsForScheme.php?schemeURI=http://purl.org/heritagedata/schemes/mda_obj
	================================================================================
	History	 :
	...
	*/	
	...
	$data = $api->getConceptsForScheme($schemeURI, $verbose, $limit, $offset, $language);
