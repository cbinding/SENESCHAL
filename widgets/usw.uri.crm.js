...
Project	: Any
Classes	: usw.uri.crm
Summary	: Constants	for	CIDOC CRM namespace, entity	and	property URIs
Example	: usage: alert(usw.uri.crm.E1) | alert(usw.uri.crm["E1"])
		either call	returns	"http://www.cidoc-crm.org/cidoc-crm/E1_CRM_Entity"
...
usw.uri.crm	= {
	...
	P150	: usw.uri.crm.NS + "P150_defines_typical_parts_of",
	P150i	: usw.uri.crm.NS + "P150i_defines_typical_wholes_for",
	P151	: usw.uri.crm.NS + "P151_was_formed_from",
	P151i	: usw.uri.crm.NS + "P151i_participated_in",
	P152	: usw.uri.crm.NS + "P152_has_parent",
	P152i	: usw.uri.crm.NS + "P152i_is_parent_of"
};
